...
processor = AutoImageProcessor.from_pretrained(f"facebook/{args.model}", image_mean=image_mean, image_std=image_std)
...
# https://huggingface.co/facebook/dinov2-base/blob/main/config.json
